        ...
        <div class="max-w-4xl mx-auto mb-12">
          <div class="relative">
            ...
            <div class="relative flex flex-col lg:flex-row gap-3 p-4 rounded-2xl bg-white shadow-2xl shadow-black/20 ring-1 ring-black/5">
              ...
              <button
                type="button"
                class="inline-flex items-center justify-center gap-3 rounded-xl bg-gradient-to-r from-primary to-primary-dark px-10 py-4 font-bold text-white shadow-lg shadow-primary/30 transition-all duration-200 hover:shadow-xl hover:shadow-primary/40 hover:scale-[1.02] active:scale-[0.98]"
